            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="mrp" required placeholder="0.00" class="w-full pl-8 pr-4 py-3 bg-white border border-slate-200 rounded-lg text-[14px] font-bold text-slate-800 focus:outline-none focus:border-slate-300 focus:ring-1 focus:ring-slate-300">
                    </div>
                </div>
                <div>
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <div class="relative block w-full bg-white border border-slate-200 rounded-lg">
                            <select name="apply_discount_to" class="w-full pl-4 pr-4 py-2.5 text-[13px] font-bold text-slate-700 outline-none appearance-none bg-transparent cursor-pointer">

    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-3 mb-4">
            <a href="{{ route('admin.products') }}"
                class="ajax-link h-8 w-8 flex items-center justify-center rounded-lg border border-slate-200 bg-white hover:bg-slate-50 hover:border-slate-300 transition shrink-0 cursor-pointer"
            ...
            <nav class="flex text-[13px] text-slate-500 font-medium">
                ...
                <a href="{{ route('admin.products') }}"
                    class="ajax-link hover:text-slate-900 transition flex items-center gap-1.5 cursor-pointer">
                    Products
                </a>
                <span class="mx-2 text-slate-300">›</span>
        ...
        <div class="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-8">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">Configure product details, visibility, and pricing for the Biogenix
                    catalog.</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="space-y-2">
                            ...
                            <input name="gst_rate" type="number" placeholder="18" value="{{ old('gst_rate') }}"
                                class="w-full bg-white border border-slate-200 text-sm rounded-xl px-4 py-3 focus:border-primary-600 focus:ring-1 focus:ring-primary-600 transition outline-none text-slate-800 placeholder:text-slate-400 font-medium">
                        </div>
                ...
                <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-4">
                        ...
                        <div id="imageDropZone"
                            ...
                            <div
                                class="h-12 w-12 rounded-full bg-slate-100 text-primary-800 flex items-center justify-center mb-4">
...
@push('scripts')
    <script>
        ...
        // Initialize with one row - Wait for DOM to be ready (supports AJAX page loading)
        setTimeout(() => {
            const tableBody = document.getElementById('variantTableBody');
            if (!tableBody) return;
            addVariantRow({pack_size: 'Default Pack', mrp: '', sku: '', stock: '100'});
        }, 0);
        ...
        function validateProductForm() {
            ...
            if (variantRows.length === 0) {
                valid = false;
                AdminToast.show('Please add at least one product variant', 'error');
            } else {

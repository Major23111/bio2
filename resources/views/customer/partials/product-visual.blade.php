<div data-catalog-placeholder-visual class="{{ $class ?? '' }} bg-slate-100/50 flex flex-col items-center justify-center text-slate-400 border border-slate-200/50 relative overflow-hidden">

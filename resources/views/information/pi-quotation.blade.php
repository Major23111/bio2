...
@section('content')
    <div class="mx-auto w-full max-w-4xl px-4 py-8 sm:px-6">
        ...
        <div class="mb-5 rounded-xl bg-white border border-slate-100 p-6 shadow-sm">
            <div class="flex flex-col md:flex-row md:items-start justify-between gap-6">
                <div>
                    <h1 class="text-[2rem] font-bold tracking-tight text-primary-800 leading-none">Create Proforma Invoice
                    </h1>
        ...
        <div class="mb-5 grid grid-cols-1 gap-5 md:grid-cols-2">
            ...
            <div class="rounded-xl bg-white border border-slate-100 p-6 shadow-sm">
                <h2 class="mb-5 flex items-center gap-2 text-sm font-bold text-slate-900 leading-none">
                    <svg class="h-4 w-4 text-primary-800" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        stroke-width="2.5">
                        <path
                ...
                <div class="space-y-4 text-left">
                    <div>
                        <label
                            class="mb-1.5 block text-[0.65rem] font-bold uppercase tracking-widest text-slate-600">Company
                            Name</label>
                    ...
                    <div>
                        <label
                            class="mb-1.5 block text-[0.65rem] font-bold uppercase tracking-widest text-slate-600">Address</label>
                    ...
                    <div>
                        <label class="mb-1.5 block text-[0.65rem] font-bold uppercase tracking-widest text-slate-600">GST
                            Number</label>
            ...
            <div class="rounded-xl bg-white border border-slate-100 p-6 shadow-sm">
                ...
                <div class="space-y-4 text-left">
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <label
                                class="mb-1.5 block text-[0.65rem] font-bold uppercase tracking-widest text-slate-600">Phone
                                / Mobile</label>
        ...
        <div class="mb-5 rounded-xl bg-slate-50 shadow-sm border border-slate-100 overflow-hidden">
            <div class="flex items-center justify-between px-6 py-5">
                <h2 class="flex items-center gap-2 text-sm font-bold text-slate-900 leading-none">
                    <svg class="h-4 w-4 text-slate-800" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        stroke-width="2.5">
            ...
            <div class="overflow-x-auto bg-white/50 border-t border-slate-100">
                <table class="w-full text-xs text-left" id="productTable">
                    <thead>
                        <tr class="bg-white">
                            <th
                                class="w-[45px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                S.No</th>
                            <th
                                class="w-[100px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Cat. No</th>
                            <th
                                class="min-w-[150px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Product Name</th>
                            <th
                                class="w-[80px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Pack</th>
                            <th
                                class="w-[60px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Qty</th>
                            <th
                                class="w-[80px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Rate</th>
                            <th
                                class="w-[90px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Value</th>
                            <th
                                class="w-[50px] whitespace-nowrap px-4 py-3 font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                GST %</th>
                            <th
                                class="w-[100px] whitespace-nowrap px-4 py-3 text-right font-bold uppercase tracking-widest text-slate-400 text-[0.65rem]">
                                Total</th>
                            <th class="w-9"></th>
                        </tr>
                    </thead>
        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
            ...
            {{-- Summary / Totals --}}
            <div
                class="rounded-xl bg-primary-600 text-white shadow-xl relative overflow-hidden flex flex-col justify-between">
                <div class="p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        <span class="text-primary-200 font-medium flex items-center gap-2">Freight Charges <svg
                ...
                <div class="mt-6 p-6 pt-0 flex justify-between gap-3">
                    <div class="flex-1 self-end pb-1.5">
                        <p class="text-[0.65rem] font-bold uppercase tracking-widest text-secondary-600 mb-1.5">Grand Total
                        </p>
    ...
    <div id="addProductModal" class="fixed inset-0 z-[9999] hidden">
        ...
        <div id="modalBackdrop"
            class="absolute inset-0 bg-slate-950/55 opacity-0 backdrop-blur-[4px] transition-opacity duration-300"></div>

        {{-- Dialog --}}
        <div class="fixed inset-0 flex items-center justify-center p-4 pointer-events-none">
            <div id="modalDialog"
                class="pointer-events-auto relative w-full max-w-[520px] translate-y-[10px] scale-95 rounded-[20px] bg-white p-8 opacity-0 shadow-[0_25px_60px_rgba(15,23,42,0.22)] transition-all duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]">
                ...
                <p class="mt-1 text-[0.82rem] text-slate-500">Search and configure product details for Biogenix Inventory
                </p>
                ...
                <div class="mt-6 grid gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div
                            class="flex h-11 items-center overflow-hidden rounded-[10px] border border-slate-200 bg-white focus-within:border-primary-600">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <div id="modalProductNameField"
                                ...
                                <input id="modalProductName" type="text" autocomplete="off"
                                    placeholder="Search or select product"
                                    class="h-full flex-1 bg-transparent pr-3 text-sm text-slate-800 outline-none placeholder:text-slate-400">
                            </div>
                            <div id="modalProductSuggestions"
                                class="absolute left-0 right-0 top-[calc(100%+0.35rem)] z-20 hidden max-h-56 overflow-y-auto rounded-[12px] border border-slate-200 bg-white p-1 shadow-[0_16px_30px_rgba(15,23,42,0.14)]">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            class="flex h-11 items-center overflow-hidden rounded-[10px] border border-slate-200 bg-slate-100">
                    ...
                    <div>
                        ...
                        <div
                            ...
                            <input id="modalRate" type="number" readonly min="0" step="0.01" value="0"
                                placeholder="&#8377; 0.00"
                                class="h-full flex-1 bg-transparent pr-3 text-sm text-slate-600 outline-none placeholder:text-slate-400">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div
                            class="flex h-11 items-center overflow-hidden rounded-[10px] border border-slate-200 bg-slate-100">
                            <span
                                class="flex h-full w-[38px] shrink-0 items-center justify-center text-[0.82rem] font-bold text-slate-500">%</span>
                ...
                <div
                    class="mt-5 flex items-center justify-between rounded-[14px] border border-slate-200 bg-slate-50 px-5 py-4">
                    <div class="flex items-center gap-2">
                        <span
                            class="inline-flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-600">
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">

...
<body
    ...
    @php($loaderLogoPath = public_path('upload/icons/biogenixlogo6.PNG'))
    @php($loaderLogoSrc = file_exists($loaderLogoPath) ? 'data:image/png;base64,' . base64_encode(file_get_contents($loaderLogoPath)) : asset('upload/icons/biogenixlogo6.PNG'))

<footer id="siteFooter" class="relative mt-6 overflow-hidden border-t border-primary-700/40 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white transition-[padding] duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]">
    ...
    <div class="relative mx-auto w-full max-w-none px-4 py-6 sm:px-6 lg:px-8 xl:px-10">
        <div class="grid gap-4 lg:grid-cols-12">
            {{-- Integrated Branding & Contact --}}
            <section class="rounded-[30px] border border-white/10 bg-white/10 p-4 shadow-[0_24px_60px_rgba(5,16,9,0.3)] backdrop-blur sm:p-5 lg:col-span-5">
            ...
            {{-- Platform Navigation --}}
            <section class="rounded-[30px] border border-white/10 bg-white/10 p-4 shadow-[0_24px_60px_rgba(5,16,9,0.3)] backdrop-blur sm:p-5 lg:col-span-2">
            ...
            <section class="rounded-[30px] border border-white/10 bg-white/10 p-4 shadow-[0_24px_60px_rgba(5,16,9,0.3)] backdrop-blur sm:p-5 lg:col-span-3">
                <h4 class="text-base font-semibold text-secondary-600/85">Direct Access Channels</h4>

                <div class="mt-4 flex flex-wrap gap-2.5">
                    <a href="mailto:support@biogenix.in" class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-primary-100/80 transition-all duration-200 hover:-translate-y-0.5 hover:border-secondary-600/35 hover:bg-secondary-600/10 hover:text-secondary-600 hover:shadow-lg hover:shadow-secondary-600/10" aria-label="Email support">
                    ...
                    <a href="tel:+919140971443" class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-primary-100/80 transition-all duration-200 hover:-translate-y-0.5 hover:border-secondary-600/35 hover:bg-secondary-600/10 hover:text-secondary-600 hover:shadow-lg hover:shadow-secondary-600/10" aria-label="Call support">
                    ...
                    <a href="https://wa.me/919140971443" target="_blank" rel="noopener noreferrer" class="inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-primary-100/80 transition-all duration-200 hover:-translate-y-0.5 hover:border-secondary-600/35 hover:bg-secondary-600/10 hover:text-secondary-600 hover:shadow-lg hover:shadow-secondary-600/10" aria-label="WhatsApp support">
        ...
        <div class="mt-6 flex flex-col gap-4 border-t border-white/10 pt-5">

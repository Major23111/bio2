...
VALUES
  (1, 'Biochemistry', 'Biochemistry reagents, controls, calibrators, and analyzer-linked chemistry products.', 'Clinical chemistry labs, diagnostic centers, hospitals, and pathology workflows', 'biochemistry', 1, 'upload/categories/Biochemistry.jpeg', 18.00, 1, NOW(), NOW()),
  (2, 'Blood Culture Bottle', 'Blood culture bottles and related microbiology sample collection products.', 'Microbiology labs, hospitals, and blood culture processing workflows', 'blood-culture-bottle', 1, 'upload/categories/Blood Culture.png', 18.00, 2, NOW(), NOW()),
  (3, 'Elisa Kits', 'ELISA kits, assay systems, and ELISA workflow products.', 'ELISA testing labs, immunoassay workflows, and research facilities', 'elisa-kits', 1, 'upload/categories/Elisa Kit.JPG.jpeg', 18.00, 3, NOW(), NOW()),
  (4, 'Haematology', 'Haematology reagents, analyzers, and CBC workflow products.', 'Haematology labs, pathology labs, and hospital laboratory departments', 'haematology', 1, 'upload/categories/Haematology - Lyse.JPG.jpeg', 18.00, 4, NOW(), NOW()),
  (5, 'Instrument', 'General laboratory and diagnostic instruments outside the IVD analyzer range.', 'Hospitals, clinics, and laboratory operations requiring diagnostic instruments', 'instrument', 1, 'upload/categories/Instruments.png', 18.00, 5, NOW(), NOW()),
  (6, 'POCT', 'Point-of-care testing analyzers, kits, and rapid near-patient workflows.', 'Critical care, emergency, physician office, and decentralized testing setups', 'poct', 1, 'upload/categories/POCT.jpeg', 18.00, 6, NOW(), NOW()),
  (7, 'Rapid', 'Rapid diagnostic tests for screening and quick turnaround workflows.', 'Hospitals, clinics, camps, laboratories, and decentralized diagnostics', 'rapid', 1, 'upload/categories/Rapid Kit.jpeg', 18.00, 7, NOW(), NOW()),
  (8, 'Serology', 'Serology kits, latex reagents, and immunology workflow products.', 'Serology labs, immunology testing, and hospital laboratory departments', 'serology', 1, 'upload/categories/Serology.jpeg', 18.00, 8, NOW(), NOW()),
  (9, 'Urinalysis', 'Urinalysis strips, analyzers, and routine urine testing products.', 'Routine urinalysis labs, hospitals, and diagnostic centers', 'urinalysis', 1, 'upload/categories/Urinalysis.jpeg', 18.00, 9, NOW(), NOW()),
  (10, 'Special Chemistry', 'Special chemistry assays including turbidimetry and advanced chemistry workflows.', 'Special chemistry testing, advanced clinical chemistry, and reference labs', 'special-chemistry', 1, 'upload/categories/Special Chemistry.jpeg', 18.00, 10, NOW(), NOW()),
  (11, 'CLIA', 'CLIA reagents, calibrators, controls, and analyzer-linked immunoassay products.', 'Chemiluminescence laboratories, immunoassay testing, and hospital labs', 'clia', 1, 'upload/categories/CLIA.jpeg', 18.00, 11, NOW(), NOW()),
  (12, 'Veterinary', 'Veterinary diagnostic reagents, kits, and analyzer-compatible products.', 'Veterinary clinics, animal diagnostics, and research institutions', 'veterinary', 1, 'upload/categories/Biochemistry.jpeg', 18.00, 12, NOW(), NOW()),
  (13, 'Molecular', 'Molecular diagnostics kits, PCR products, and nucleic-acid testing workflows.', 'Molecular labs, PCR setups, infectious disease testing, and research labs', 'molecular', 1, 'upload/categories/CLIA.jpeg', 18.00, 13, NOW(), NOW()),
  (14, 'Microbiology', 'Microbiology media, culture systems, and organism detection products.', 'Microbiology departments, culture workflows, and hospital laboratories', 'microbiology', 1, 'upload/categories/Blood Culture.png', 18.00, 14, NOW(), NOW()),
  (15, 'IVD Instruments', 'In-vitro diagnostic analyzers and related instrument platforms.', 'Diagnostic laboratories, hospital labs, and institutional IVD installations', 'ivd-instruments', 1, 'upload/categories/IVD Instruments.png', 18.00, 15, NOW(), NOW())
...
DELETE FROM product_image WHERE id BETWEEN 950001 AND 950141;
DELETE FROM product_image WHERE product_id BETWEEN 910001 AND 910094;
...
-- ============================================================
-- SECTION 11: PRODUCT IMAGES
-- ============================================================

INSERT INTO product_image (id, product_id, file_path, is_primary, sort_order, created_at, updated_at)
VALUES
  (950001, 910001, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950002, 910002, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950003, 910003, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950004, 910004, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950005, 910005, 'upload/products/Product Photos - Biogenix/Biochemistry/Liver Function Test (LFT)/Biochemistry - Liver Function Test (LFT)(1).jpg', 1, 1, NOW(), NOW()),
  (950006, 910006, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950007, 910007, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950008, 910008, 'upload/products/Product Photos - Biogenix/Biochemistry/HDL Cholesterol/Biochemistry - Cholesterol HDL Direct(1).JPG', 1, 1, NOW(), NOW()),
  (950009, 910008, 'upload/products/Product Photos - Biogenix/Biochemistry/HDL Cholesterol/Biochemistry - Cholesterol HDL Direct(2).JPG', 0, 2, NOW(), NOW()),
  (950010, 910009, 'upload/products/Product Photos - Biogenix/Biochemistry/HDL D Cholesterol/Biochemistry - Cholesterol HDL Direct(1).JPG', 1, 1, NOW(), NOW()),
  (950011, 910009, 'upload/products/Product Photos - Biogenix/Biochemistry/HDL D Cholesterol/Biochemistry - Cholesterol HDL Direct(2).jpg', 0, 2, NOW(), NOW()),
  (950012, 910010, 'upload/products/Product Photos - Biogenix/Biochemistry/LDL D Cholesterol/Biochemistry - LDL Direct(1).jpg', 1, 1, NOW(), NOW()),
  (950013, 910010, 'upload/products/Product Photos - Biogenix/Biochemistry/LDL D Cholesterol/Biochemistry - LDL Direct(2).jpg', 0, 2, NOW(), NOW()),
  (950014, 910011, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950015, 910012, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950016, 910013, 'upload/products/Product Photos - Biogenix/Biochemistry/CK NAC/Biochemistry - CK.NAC(1).jpg', 1, 1, NOW(), NOW()),
  (950017, 910014, 'upload/products/Product Photos - Biogenix/Biochemistry/CK NAC/Biochemistry - CK.NAC(1).jpg', 1, 1, NOW(), NOW()),
  (950018, 910014, 'upload/products/Product Photos - Biogenix/Biochemistry/CK NAC/Biochemistry - CK.NAC.jpg', 0, 2, NOW(), NOW()),
  (950019, 910015, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950020, 910016, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950021, 910017, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950022, 910018, 'upload/products/Product Photos - Biogenix/Biochemistry/Gamma GT/Biochemistry - Gamma GT(2).jpg', 1, 1, NOW(), NOW()),
  (950023, 910019, 'upload/products/Product Photos - Biogenix/Biochemistry/G6PD/1.jpg', 1, 1, NOW(), NOW()),
  (950024, 910019, 'upload/products/Product Photos - Biogenix/Biochemistry/G6PD/2.jpg', 0, 2, NOW(), NOW()),
  (950025, 910020, 'upload/products/Product Photos - Biogenix/Biochemistry/HbA1c/Biochemistry - HbA1C(1).jpg', 1, 1, NOW(), NOW()),
  (950026, 910020, 'upload/products/Product Photos - Biogenix/Biochemistry/HbA1c/Biochemistry - HbA1C(2).jpg', 0, 2, NOW(), NOW()),
  (950027, 910021, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950028, 910022, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950029, 910023, 'upload/products/Product Photos - Biogenix/Biochemistry/LDH/Biochemistry - LDH(2).jpg', 1, 1, NOW(), NOW()),
  (950030, 910023, 'upload/products/Product Photos - Biogenix/Biochemistry/LDH/Biochemistry - LDH(3).jpg', 0, 2, NOW(), NOW()),
  (950031, 910024, 'upload/products/Product Photos - Biogenix/Biochemistry/Lipase/Biochemistry - Lipase(1).jpg', 1, 1, NOW(), NOW()),
  (950032, 910024, 'upload/products/Product Photos - Biogenix/Biochemistry/Lipase/Biochemistry - Lipase(2).jpg', 0, 2, NOW(), NOW()),
  (950033, 910025, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950034, 910026, 'upload/products/Product Photos - Biogenix/Biochemistry/Micro Protein/1.jpg', 1, 1, NOW(), NOW()),
  (950035, 910026, 'upload/products/Product Photos - Biogenix/Biochemistry/Micro Protein/2.jpg', 0, 2, NOW(), NOW()),
  (950036, 910027, 'upload/products/Product Photos - Biogenix/Biochemistry/Phosphorus/Biochemistry - Phosphorous(1).jpg', 1, 1, NOW(), NOW()),
  (950037, 910027, 'upload/products/Product Photos - Biogenix/Biochemistry/Phosphorus/Biochemistry - Phosphorous(2).jpg', 0, 2, NOW(), NOW()),
  (950038, 910028, 'upload/products/Product Photos - Biogenix/Biochemistry/Potassium/Biochemistry - Potassium(1).jpg', 1, 1, NOW(), NOW()),
  (950039, 910028, 'upload/products/Product Photos - Biogenix/Biochemistry/Potassium/Biochemistry - Potassium.jpg', 0, 2, NOW(), NOW()),
  (950040, 910029, 'upload/products/Product Photos - Biogenix/Biochemistry/Sodium/Biochemistry - Sodium(1).jpg', 1, 1, NOW(), NOW()),
  (950041, 910029, 'upload/products/Product Photos - Biogenix/Biochemistry/Sodium/Biochemistry - Sodium(2).jpg', 0, 2, NOW(), NOW()),
  (950042, 910030, 'upload/products/Product Photos - Biogenix/Biochemistry/SGPT/Biochemistry - SGPT(1).jpg', 1, 1, NOW(), NOW()),
  (950043, 910030, 'upload/products/Product Photos - Biogenix/Biochemistry/SGPT/Biochemistry - SGPT(2).jpg', 0, 2, NOW(), NOW()),
  (950044, 910031, 'upload/products/Product Photos - Biogenix/Biochemistry/SGOT/Biochemistry - SGOT(1).JPG', 1, 1, NOW(), NOW()),
  (950045, 910031, 'upload/products/Product Photos - Biogenix/Biochemistry/SGOT/Biochemistry - SGOT(2).jpg', 0, 2, NOW(), NOW()),
  (950046, 910032, 'upload/products/Product Photos - Biogenix/Biochemistry/Total Protein/Biochemistry - Total Protein(1).jpg', 1, 1, NOW(), NOW()),
  (950047, 910032, 'upload/products/Product Photos - Biogenix/Biochemistry/Total Protein/Biochemistry - Total Protein(2).jpg', 0, 2, NOW(), NOW()),
  (950048, 910033, 'upload/products/Product Photos - Biogenix/Biochemistry/Triglyceride/Biochemistry - Triglyceride(1).jpg', 1, 1, NOW(), NOW()),
  (950049, 910033, 'upload/products/Product Photos - Biogenix/Biochemistry/Triglyceride/Biochemistry - Triglyceride(2).jpg', 0, 2, NOW(), NOW()),
  (950050, 910034, 'upload/products/Product Photos - Biogenix/Biochemistry/Urea Berthelot/Biochemistry - Urea Berthelot(1).JPG', 1, 1, NOW(), NOW()),
  (950051, 910034, 'upload/products/Product Photos - Biogenix/Biochemistry/Urea Berthelot/Biochemistry - Urea Berthelot(2).jpg', 0, 2, NOW(), NOW()),
  (950052, 910035, 'upload/products/Product Photos - Biogenix/Biochemistry/Urea/Biochemistry - Urea(1).jpg', 1, 1, NOW(), NOW()),
  (950053, 910035, 'upload/products/Product Photos - Biogenix/Biochemistry/Urea/Biochemistry - Urea(2).jpg', 0, 2, NOW(), NOW()),
  (950054, 910036, 'upload/products/Product Photos - Biogenix/Biochemistry/Uric Acid/Biochemistry - Uric Acid(1).jpg', 1, 1, NOW(), NOW()),
  (950055, 910036, 'upload/products/Product Photos - Biogenix/Biochemistry/Uric Acid/Biochemistry - Uric Acid(2).jpg', 0, 2, NOW(), NOW()),
  (950056, 910037, 'upload/products/Product Photos - Biogenix/Biochemistry/Kidney Function Test (KFT) Panel/DSC_7948 (Custom).JPG', 1, 1, NOW(), NOW()),
  (950057, 910038, 'upload/products/Product Photos - Biogenix/Serology/ASO LATEX/Serology - ASO Latex(1).JPG', 1, 1, NOW(), NOW()),
  (950058, 910038, 'upload/products/Product Photos - Biogenix/Serology/ASO LATEX/Serology - ASO Latex(2).JPG', 0, 2, NOW(), NOW()),
  (950059, 910039, 'upload/products/Product Photos - Biogenix/Serology/CRP LATEX/Serology - CRP Latex.jpg', 1, 1, NOW(), NOW()),
  (950060, 910040, 'upload/products/Product Photos - Biogenix/Biochemistry/RF Turbi/Biochemistry - RF Turbi(1).jpg', 1, 1, NOW(), NOW()),
  (950061, 910040, 'upload/products/Product Photos - Biogenix/Biochemistry/RF Turbi/Biochemistry - RF Turbi(2).JPG', 0, 2, NOW(), NOW()),
  (950062, 910041, 'upload/products/Product Photos - Biogenix/Biochemistry/RF Turbi/Biochemistry - RF Turbi(1).jpg', 1, 1, NOW(), NOW()),
  (950063, 910042, 'upload/products/Product Photos - Biogenix/Biochemistry/RF Turbi/Biochemistry - RF Turbi(1).jpg', 1, 1, NOW(), NOW()),
  (950064, 910043, 'upload/products/Product Photos - Biogenix/Rapid Tests/Dengue Combo/Dengue Combo(1).jpg', 1, 1, NOW(), NOW()),
  (950065, 910043, 'upload/products/Product Photos - Biogenix/Rapid Tests/Dengue Combo/Dengue Combo(2).jpg', 0, 2, NOW(), NOW()),
  (950066, 910044, 'upload/products/Product Photos - Biogenix/Rapid Tests/Dengue IgG IgM/Dengue IgG_IgM Rapid Test(1).jpg', 1, 1, NOW(), NOW()),
  (950067, 910044, 'upload/products/Product Photos - Biogenix/Rapid Tests/Dengue IgG IgM/Dengue IgG_IgM Rapid Test(2).jpg', 0, 2, NOW(), NOW()),
  (950068, 910045, 'upload/products/Product Photos - Biogenix/Rapid Tests/H. Pylori Ab/Rapid Test - H.Pylori Ab(1).JPG', 1, 1, NOW(), NOW()),
  (950069, 910045, 'upload/products/Product Photos - Biogenix/Rapid Tests/H. Pylori Ab/Rapid Test - H.Pylori Ab(2).JPG', 0, 2, NOW(), NOW()),
  (950070, 910046, 'upload/products/Product Photos - Biogenix/Rapid Tests/H. Pylori Ab/Rapid Test - H.Pylori Ab(1).JPG', 1, 1, NOW(), NOW()),
  (950071, 910047, 'upload/products/Product Photos - Biogenix/Rapid Tests/Malaria PfPv/Rapid Test - Malaria Pf_Pv(1).JPG', 1, 1, NOW(), NOW()),
  (950072, 910047, 'upload/products/Product Photos - Biogenix/Rapid Tests/Malaria PfPv/Rapid Test - Malaria Pf_Pv(2).JPG', 0, 2, NOW(), NOW()),
  (950073, 910048, 'upload/products/Product Photos - Biogenix/Rapid Tests/Malaria PfPAN/Pouch with box.jpeg', 1, 1, NOW(), NOW()),
  (950074, 910049, 'upload/products/Product Photos - Biogenix/Rapid Tests/Pregnancy (hCG) Rapid Test/Rapid Test - Pregnancy (HcG)(1).jpg', 1, 1, NOW(), NOW()),
  (950075, 910049, 'upload/products/Product Photos - Biogenix/Rapid Tests/Pregnancy (hCG) Rapid Test/Rapid Test - Pregnancy (HcG)(2).jpg', 0, 2, NOW(), NOW()),
  (950076, 910050, 'upload/products/Product Photos - Biogenix/Rapid Tests/Syphilis/Rapid Test - Syphilis(1).JPG', 1, 1, NOW(), NOW()),
  (950077, 910050, 'upload/products/Product Photos - Biogenix/Rapid Tests/Syphilis/Rapid Test - Syphilis(2).jpg', 0, 2, NOW(), NOW()),
  (950078, 910051, 'upload/products/Product Photos - Biogenix/Rapid Tests/HIV 1-2/Rapid Test - HIV 1_2(1).jpg', 1, 1, NOW(), NOW()),
  (950079, 910051, 'upload/products/Product Photos - Biogenix/Rapid Tests/HIV 1-2/Rapid Test - HIV 1_2(2).jpg', 0, 2, NOW(), NOW()),
  (950080, 910052, 'upload/products/Product Photos - Biogenix/Rapid Tests/HCV/Rapid Test - HCV(1).jpg', 1, 1, NOW(), NOW()),
  (950081, 910052, 'upload/products/Product Photos - Biogenix/Rapid Tests/HCV/Rapid Test - HCV(2).jpg', 0, 2, NOW(), NOW()),
  (950082, 910053, 'upload/products/Product Photos - Biogenix/Rapid Tests/HBsAg/Rapid Test - HbsAg(1).jpg', 1, 1, NOW(), NOW()),
  (950083, 910053, 'upload/products/Product Photos - Biogenix/Rapid Tests/HBsAg/Rapid Test - HbsAg(2).jpg', 0, 2, NOW(), NOW()),
  (950084, 910054, 'upload/products/Product Photos - Biogenix/Rapid Tests/Typhoid IgG-IgM/Rapid Test - Typhoid IgG_IgM(1).jpg', 1, 1, NOW(), NOW()),
  (950085, 910054, 'upload/products/Product Photos - Biogenix/Rapid Tests/Typhoid IgG-IgM/Rapid Test - Typhoid IgG_IgM(2).jpg', 0, 2, NOW(), NOW()),
  (950086, 910055, 'upload/products/Product Photos - Biogenix/Rapid Tests/Sickle Cell/Rapid Test - Sickle Cell(1).jpg', 1, 1, NOW(), NOW()),
  (950087, 910055, 'upload/products/Product Photos - Biogenix/Rapid Tests/Sickle Cell/Rapid Test - Sickle Cell.jpg', 0, 2, NOW(), NOW()),
  (950088, 910056, 'upload/products/Product Photos - Biogenix/Urinalysis/2P Urine Stick/Urinalysis - 2P Urine Sticks(1).jpg', 1, 1, NOW(), NOW()),
  (950089, 910056, 'upload/products/Product Photos - Biogenix/Urinalysis/2P Urine Stick/Urinalysis - 2P Urine Sticks(2).jpg', 0, 2, NOW(), NOW()),
  (950090, 910057, 'upload/products/Product Photos - Biogenix/Urinalysis/10-P/Urinalysis - 10P(1).JPG', 1, 1, NOW(), NOW()),
  (950091, 910057, 'upload/products/Product Photos - Biogenix/Urinalysis/10-P/Urinalysis - 10P(2).JPG', 0, 2, NOW(), NOW()),
  (950092, 910058, 'upload/products/Product Photos - Biogenix/Urinalysis/10-P/Urinalysis - 10P(1).JPG', 1, 1, NOW(), NOW()),
  (950093, 910058, 'upload/products/Product Photos - Biogenix/Urinalysis/10-P/Urinalysis - 10P(2).JPG', 0, 2, NOW(), NOW()),
  (950094, 910059, 'upload/products/Product Photos - Biogenix/Serology/ASO LATEX/Serology - ASO Latex(1).JPG', 1, 1, NOW(), NOW()),
  (950095, 910059, 'upload/products/Product Photos - Biogenix/Serology/ASO LATEX/Serology - ASO Latex(2).JPG', 0, 2, NOW(), NOW()),
  (950096, 910060, 'upload/products/Product Photos - Biogenix/Serology/CRP LATEX/Serology - CRP Latex.jpg', 1, 1, NOW(), NOW()),
  (950097, 910061, 'upload/products/Product Photos - Biogenix/Serology/RF LATEX/Serology - RF Latex(1).JPG', 1, 1, NOW(), NOW()),
  (950098, 910061, 'upload/products/Product Photos - Biogenix/Serology/RF LATEX/Serology - RF Latex.jpg', 0, 2, NOW(), NOW()),
  (950099, 910062, 'upload/products/Product Photos - Biogenix/Serology/RPR LATEX/Serology - RPR Latex(1).JPG', 1, 1, NOW(), NOW()),
  (950100, 910062, 'upload/products/Product Photos - Biogenix/Serology/RPR LATEX/Serology - RPR Latex(2).JPG', 0, 2, NOW(), NOW()),
  (950101, 910063, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - Complete Reagents(1).JPG', 1, 1, NOW(), NOW()),
  (950102, 910064, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - Lyse(1).JPG', 1, 1, NOW(), NOW()),
  (950103, 910064, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - Lyse(2).JPG', 0, 2, NOW(), NOW()),
  (950104, 910065, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - Complete Reagents(1).JPG', 1, 1, NOW(), NOW()),
  (950105, 910066, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - Probe Cleaner.JPG', 1, 1, NOW(), NOW()),
  (950106, 910067, 'upload/products/Product Photos - Biogenix/Haematology/Haematology - EZ Cleaner.JPG', 1, 1, NOW(), NOW()),
  (950107, 910067, 'upload/products/Product Photos - Biogenix/Haematology/Hematology - EZ Cleaner(1).jpg', 0, 2, NOW(), NOW()),
  (950108, 910068, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950109, 910069, 'upload/products/Product Photos - Biogenix/Elisa Kits/ELISA/Elisa Kit - Elisa Kit - TSH.png', 1, 1, NOW(), NOW()),
  (950110, 910070, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950111, 910071, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950112, 910072, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950113, 910073, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950114, 910074, 'upload/products/Product Photos - Biogenix/Elisa Kits/Elisa Kits - Common/Elisa Kit - Common Box and Components.JPG', 1, 1, NOW(), NOW()),
  (950115, 910075, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Hematology/Hematology Analyser - 3.Part.png', 1, 1, NOW(), NOW()),
  (950116, 910075, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Hematology/Hematology Analyser - 3.Part(1).png', 0, 2, NOW(), NOW()),
  (950117, 910076, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Hematology/Hematology Analyser - 5.Part (Veterinary).jpg', 1, 1, NOW(), NOW()),
  (950118, 910077, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Hematology/Hematology Analyser - 5.Part(1).jpg', 1, 1, NOW(), NOW()),
  (950119, 910078, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-10S(1).jpg', 1, 1, NOW(), NOW()),
  (950120, 910078, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-10S(3).jpg', 0, 2, NOW(), NOW()),
  (950121, 910079, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-501 plus.jpg', 1, 1, NOW(), NOW()),
  (950122, 910079, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-501.jpg', 0, 2, NOW(), NOW()),
  (950123, 910080, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/CLIA/BI-1000/BI-1000.png', 1, 1, NOW(), NOW()),
  (950124, 910081, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/CLIA/BI-1000/BI-1000.png', 1, 1, NOW(), NOW()),
  (950125, 910082, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-501 plus.jpg', 1, 1, NOW(), NOW()),
  (950126, 910083, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-501.jpg', 1, 1, NOW(), NOW()),
  (950127, 910084, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Semi BC/BI-501 plus.jpg', 1, 1, NOW(), NOW()),
  (950128, 910085, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Fully Urine analyzer/fau copy.png', 1, 1, NOW(), NOW()),
  (950129, 910085, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Fully Urine analyzer/u6001.jpg', 0, 2, NOW(), NOW()),
  (950130, 910086, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/POCT/POCT Analyser.png', 1, 1, NOW(), NOW()),
  (950131, 910086, 'upload/products/Product Photos - Biogenix/POCT/HB Strips/POCT - Hemaglobin Analyser(1).jpg', 0, 2, NOW(), NOW()),
  (950132, 910087, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Blood Culture/BI-32/BI-32(1).jpg', 1, 1, NOW(), NOW()),
  (950133, 910087, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Blood Culture/BI-32/BI-32.jpg', 0, 2, NOW(), NOW()),
  (950134, 910088, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Hba1c HPLC/17 copy.png', 1, 1, NOW(), NOW()),
  (950135, 910089, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/Electrolyte/ELE 2.jpg', 1, 1, NOW(), NOW()),
  (950136, 910090, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/POCT/POCT Analyser.png', 1, 1, NOW(), NOW()),
  (950137, 910091, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/ELISA Reader and washer/ER1 (2).jpg', 1, 1, NOW(), NOW()),
  (950138, 910091, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/ELISA Reader and washer/er1.jpg', 0, 2, NOW(), NOW()),
  (950139, 910092, 'upload/products/Product Photos - Biogenix/Instrument Images/Instruments/ELISA Reader and washer/ew1 (2).jpg', 1, 1, NOW(), NOW()),
  (950140, 910093, 'upload/products/Product Photos - Biogenix/POCT/HB Strips/POCT - Hemaglobin Strip.jpg', 1, 1, NOW(), NOW()),
  (950141, 910094, 'upload/products/Product Photos - Biogenix/Biochemistry/HbA1c/Biochemistry - HbA1C(1).jpg', 1, 1, NOW(), NOW());
